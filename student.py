...
def apply_for_drive(drive_id):
    ...
    existing = conn.execute("select 1 from application where student_id = ? and drive_id = ?", (student_id, drive_id)).fetchone()
